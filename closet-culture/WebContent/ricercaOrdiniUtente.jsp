...
<head>
  <title>Closet Culture</title>
    ...
    <meta charset="UTF-8">
    <title>Ricerca Ordini Utente</title>
</head>
  <%@ include file="fragments/header.jsp"%>

<body style="margin:15px!important">
    <h1>Ricerca Ordini Utente</h1>
    <input type="text" id="search-input" value="<%=currentUser.getUsername()%>" placeholder="Inserisci l'username dell'utente" disabled>
